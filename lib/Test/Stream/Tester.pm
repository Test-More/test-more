...
Test::Stream::Tester - Essential basic tools for testing Test::Stream, and Test::Stream based
tools.
...
This library exports some essential tools needed for Test::Stream, and frameworks
built on it, to test themselves. These tools are bare-bones and intended only
for Test::Stream, and frameworks built on top of it. Think of this as a testing
