...
Test::CanThread - Skip a test file unless the system supports threading
...
Duplicating this non-trivial code in all tests that need to use threafs is
...
Test::CanThread uses L<Test::Stream> under the hood.
