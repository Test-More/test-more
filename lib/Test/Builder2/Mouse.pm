# This file was generated by Test::Builder2::Mouse::Maker 0.12 from Mouse 0.87.
#
# ANY CHANGES MADE HERE WILL BE LOST!
use strict;
use warnings;

# tell Perl we already have all of the Test::Builder2::Mouse files loaded:
BEGIN {
	...
	$INC{'Test/Builder2/Mouse/Meta/Role/Application.pm'}       = __FILE__;
...
use strict;
use warnings;
use warnings FATAL => 'redefine'; # to avoid to load Test::Builder2::Mouse::PurePerl twice
...
sub linearized_isa { @{ Test::Builder2::Mouse::Util::get_linear_isa($_[0]->{package}) } }
...
sub _initialize_object{
	...
	# when an attribute is added. See Test::Builder2::Mouse::Meta::Class::add_attribute.
...
sub _process_options{
	...
	if(exists $args->{builder}){
		# XXX:
		# Moose refuses a CODE ref builder, but Test::Builder2::Mouse doesn't for backward compatibility
...
sub do_import {
	...
	my $spec = $SPEC{$package}
		|| Carp::confess("The package $package package does not use Test::Builder2::Mouse::Exporter");
...
sub do_unimport {
	...
	my $spec = $SPEC{$package}
		|| Carp::confess("The package $package does not use Test::Builder2::Mouse::Exporter");
...
BEGIN{
	...
	# Because Test::Builder2::Mouse::Util is loaded first in all the Test::Builder2::Mouse sub-modules,
	# XSLoader must be placed here, not in Test/Builder2/Mouse.pm.
	if($xs){
...
sub apply_all_roles {
	my $consumer = Scalar::Util::blessed($_[0])
		?                                $_[0]   # instance
		: Test::Builder2::Mouse::Meta::Class->initialize($_[0]); # class or role name
	...
	for (my $i = 1; $i < $max ; $i++) {
		...
		is_a_metarole($role)
			|| $consumer->meta->throw_error("You can only consume roles, $role_name is not a Test::Builder2::Mouse role");
	}
...
sub not_supported{
	...
	Carp::confess("Test::Builder2::Mouse does not currently support $feature");
}
...
sub _unite { # overload infix:<|>
	my($lhs, $rhs) = @_;
	require Test::Builder2::Mouse::Util::TypeConstraints;
	return Test::Builder2::Mouse::Util::TypeConstraints::_find_or_create_union_type(
		$lhs,
		Test::Builder2::Mouse::Util::TypeConstraints::find_or_create_isa_type_constraint($rhs),
	);
}
...
sub _define_type {
	...
	if(defined $name){
		...
		if(!$this){
			$this = caller(1);
			if($this !~ /\A Test::Builder2::Mouse \b/xms){
	...
	my $constraint = Test::Builder2::Mouse::Meta::TypeConstraint->new(%args);
	...
	return subtype $name => (
		...
		optimized_as => sub {
			return Scalar::Util::blessed($_[0])
				&& Test::Builder2::Mouse::Util::does_role($_[0], $role);
		},
		role         => $role,
	);
}
...
sub find_type_constraint {
	my($spec) = @_;
	return $spec if Test::Builder2::Mouse::Util::is_a_type_constraint($spec) or not defined $spec;
...
sub find_or_create_does_type_constraint{
	# XXX: Moose does not register a new role_type, but Test::Builder2::Mouse does.
	my $tc = find_or_parse_type_constraint(@_);
	return defined($tc) ? $tc : role_type(@_);
}

sub find_or_create_isa_type_constraint {
	# XXX: Moose does not register a new class_type, but Test::Builder2::Mouse does.
	my $tc = find_or_parse_type_constraint(@_);
	return defined($tc) ? $tc : class_type(@_);
}

# Contents of Mouse
package Test::Builder2::Mouse::TOP;
use 5.006_002;
...
sub init_meta {
	...
	# make a class type for each Test::Builder2::Mouse class
...
my %valid_options = map { $_ => undef } (
  ...
  # Moose defines, but Test::Builder2::Mouse doesn't
  #'definition_context',
  #'initializer',
...
sub install_accessors{
	...
	if(exists $attribute->{handles}){
		...
		while(my($handle, $method_to_call) = each %handles){
			next if Test::Builder2::Mouse::Object->can($handle);
...
sub _find_delegate_metaclass {
	...
	my $meta;
	if($self->{isa}) {
		$meta = Test::Builder2::Mouse::Meta::Class->initialize("$self->{isa}");
	}
	elsif($self->{does}) {
		$meta = Test::Builder2::Mouse::Util::get_metaclass_by_name("$self->{does}");
	}
...
our @CARP_NOT = qw(Test::Builder2::Mouse); # trust Mousse
...
sub verify_superclass {
	...
	if(defined $super_meta) {
		if(Test::Builder2::Mouse::Util::is_a_metarole($super_meta)){
			$self->throw_error("You cannot inherit from a Test::Builder2::Mouse Role ($super)");
		}
	}
	else {
		# The metaclass of $super is not initialized.
		# i.e. it might be Test::Builder2::Mouse::Object, a mixin package (e.g. Exporter),
		# or a foreign class including Moose classes.
		# See also Test::Builder2::Mouse::Foreign::Meta::Role::Class.
		my $mm = $super->can('meta');
		if(!($mm && $mm == \&Test::Builder2::Mouse::Util::meta)) {
...
sub inherit_from_foreign_class {
	my($class, $super) = @_;
	Carp::carp("You inherit from non-Test::Builder2::Mouse class ($super),"
		. " but it is unlikely to work correctly."
		. " Please consider using Test::Builder2::MouseX::Foreign");
	return;
}
...
sub add_override_method_modifier {
	...
	$self->add_method($name => sub {
		local $Test::Builder2::Mouse::TOP::SUPER_PACKAGE = $package;
		local $Test::Builder2::Mouse::TOP::SUPER_BODY    = $super_body;
		local @Test::Builder2::Mouse::TOP::SUPER_ARGS    = @_;
		&{$code};
	});
	return;
}
...
sub add_augment_method_modifier {
	...
	$self->add_method($name => sub {
		local $Test::Builder2::Mouse::TOP::INNER_BODY{$super_package} = $code;
		local $Test::Builder2::Mouse::TOP::INNER_ARGS{$super_package} = [@_];
		&{$super_body};
	});
	return;
}
...
sub _generate_destructor{
	...
	for my $class ($metaclass->linearized_isa) {
		if (Test::Builder2::Mouse::Util::get_code_ref($class, 'DEMOLISH')) {
			$demolishall .= '                ' . $class
				. '::DEMOLISH($self, $Test::Builder2::Mouse::Util::in_global_destruction);'
				. "\n",
		}
	}
...
#line 1 "%s"
	...
	sub {
		my($self) = @_;
		return $self->Test::Builder2::Mouse::Object::DESTROY()
			if ref($self) ne __PACKAGE__;
		# DEMOLISHALL
		%s;
		return;
...
# The public versions are aliased into Test::Builder2::Mouse::Util::*.
...
my %foreign = map{ $_ => undef } qw(
	Test::Builder2::Mouse Test::Builder2::Mouse::Role Test::Builder2::Mouse::Util Test::Builder2::Mouse::Util::TypeConstraints
	Carp Scalar::Util List::Util
);
sub _get_method_body {
	my($self, $method_name) = @_;
	my $code = Test::Builder2::Mouse::Util::get_code_ref($self->{package}, $method_name);
	return $code && !exists $foreign{ Test::Builder2::Mouse::Util::get_code_package($code) }
		? $code
		: undef;
}
...
sub _collect_methods { # Test::Builder2::Mouse specific, used for method modifiers
	my($meta, @args) = @_;
...
sub apply {
	...
	require 'Test/Builder2/Mouse/Meta/Role/Application.pm';
	return Test::Builder2::Mouse::Meta::Role::Application->new(@_)->apply($self, $consumer);
}

sub combine {
	my($self, @role_specs) = @_;

	require 'Test/Builder2/Mouse/Meta/Role/Composite.pm';
	return Test::Builder2::Mouse::Meta::Role::Composite->new(roles => \@role_specs);
}
...
package Test::Builder2::Mouse::Meta::Role::Application;
use Test::Builder2::Mouse::Util qw(:meta);
...
sub apply {
	...
	if(Test::Builder2::Mouse::Util::is_a_metaclass($consumer)) {   # Application::ToClass
		...
		$consumer = (Test::Builder2::Mouse::Util::class_of($instance) || 'Test::Builder2::Mouse::Meta::Class')
			->create_anon_class(
...
use Test::Builder2::Mouse::Util; # enables strict and warnings
use Test::Builder2::Mouse::Meta::Role;
use Test::Builder2::Mouse::Meta::Role::Application;
our @ISA = qw(Test::Builder2::Mouse::Meta::Role);

# FIXME: Test::Builder2::Mouse::Meta::Role::Composite does things in different way from Moose's
# Moose: creates a new class for the consumer, and applies roles to it.
# Test::Builder2::Mouse: creates a coposite role and apply roles to the role,
...
sub apply {
	...
	Test::Builder2::Mouse::Meta::Role::Application::RoleSummation->new(@_)->apply($self, $consumer);
	return;
}

package Test::Builder2::Mouse::Meta::Role::Application::RoleSummation;
our @ISA = qw(Test::Builder2::Mouse::Meta::Role::Application);
...
sub super {
	return if !defined $Test::Builder2::Mouse::TOP::SUPER_BODY;
	$Test::Builder2::Mouse::TOP::SUPER_BODY->(@Test::Builder2::Mouse::TOP::SUPER_ARGS);
}
...
sub excludes {
	Test::Builder2::Mouse::Util::not_supported();
}
...
sub init_meta{
	...
	# make a role type for each Test::Builder2::Mouse role
...
Test::Builder2::Mouse::Exporter->setup_import_methods(also => 'Test::Builder2::Mouse::TOP');
