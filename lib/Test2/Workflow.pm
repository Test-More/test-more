...
use Test2::Workflow::Meta();
use Test2::Workflow::Unit();

use Test2::API qw/context/;
use Test2::Util qw/try/;
use Test2::Util::Sub qw/sub_info/;
use Test2::Workflow::Util qw/set_sub_name CAN_SET_SUB_NAME update_mask/;
...
sub _current {
    ...
    my $spec_meta = Test2::Workflow::Meta->get($caller) || return;
...
See L<Test2::Workflow::Meta> where the primary unit is stored.
...
Get the L<Test2::Workflow::Meta> object associated with the current
package.
...
L<Test2::Workflow::Unit>, the coderef that was passed in, and a caller
arrayref.
