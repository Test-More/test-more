...
This function takes an arraref of events as the first argument. All additional
...
If the package of an event is not known it wil be put into and arrayref under
